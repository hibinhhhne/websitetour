            ...
            <div class="card-body">
                <form id="form_create">
                    ...
                    <div class="form-group">
                        ...
                        <input v-model="add.ten_khach_san" type="text" class="form-control" placeholder="Nhập vào Tên Khách Sạn" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input v-model="add.ten_phuong_tien" type="text" class="form-control" placeholder="Nhập vào Tên Phương Tiện">
                    </div>
                    <div class="form-group">
                        <label>Tên Tỉnh Thành</label>
                        <input v-model="add.ten_tinh_thanh" type="text" class="form-control" placeholder="Nhập vào Tên Tỉnh Thành">
                    </div>
                    <div class="form-group">
                        <label>Số Ngày</label>
                        ...
                        <table class="table table-bordered" >
                            ...
                            <tbody>
                                <tr v-for="(value, key) in list">
                                    <th class="text-center align-middle">@{{ key + 1 }}</th>
                                        ...
                                        <td class="align-middle">@{{ value.lmo_ta }}</td>
                                        <td class="align-middle">@{{ value.ten_phuong_tien }}</td>
                                        <td class="align-middle">@{{ value.ten_tinh_thanh }}</td>
                                ...
                                <div class="modal-dialog modal-lg">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" v-model="edit.id" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input v-model="edit.ten_khach_san" type="text" class="form-control" placeholder="Nhập vào ID Khách Sạn" >
                                            </div>
                                            <div class="form-group">
                                                <label>List Địa Điểm Tham Quan</label>
                                                <textarea v-model="edit.list_dia_diem_tham_quan" class="form-control" cols="30" rows="5"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Mô Tả</label>
                                            ...
                                            <div class="form-group">
                                                <label>Tên Phương Tiện</label>
                                                <input v-model="edit.ten_phuong_tien" type="text" class="form-control" placeholder="Nhập vào Tên Phương Tiện">
                                            </div>
                                            <div class="form-group">
                                                <label>Tên Tỉnh Thành</label>
                                                <input v-model="edit.ten_tinh_thanh" type="text" class="form-control" placeholder="Nhập vào Tên Tỉnh Thành">
                                            </div>
                                            <div class="form-group">
                                                <label>Số Ngày</label>
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <button v-on:click="capNhatChiTietTour()" class="btn btn-primary" data-dismiss="modal">Cập Nhật</button>
                                    </div>
                                  </div>
                                </div>
                            </div>
                            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                                    <button v-on:click="xoaChiTietTour()" class="btn btn-danger" data-dismiss="modal">Xóa</button>
                                    </div>
                                </div>
                                </div>
                            </div>
        ...
        new Vue({
            ...
            methods :   {
                ...
                themMoi()   {
                    ...
                    axios
                        .post('/admin/chi-tiet-tour/create', this.add)
                        .then((res) => {
                ...
                doiTrangThai(payload){
                    axios
                        .post('/admin/chi-tiet-tour/change-status', payload )
                        .then((res) => {
                            if(res.data.status) {
                                this.loadChiTietTour();
                            }
                ...
                capNhatChiTietTour(){
                    ...
                    axios
                        .post('/admin/chi-tiet-tour/update', this.edit)
                        .then((res) => {
                            if(res.data.status == true) {
                                this.loadChiTietTour();
                            }
                ...
                xoaChiTietTour(){
                    axios
                        .post('/admin/chi-tiet-tour/delete', this.del)
                        .then((res) => {
                            if(res.data.status == true) {
                                this.loadChiTietTour();
                            }
