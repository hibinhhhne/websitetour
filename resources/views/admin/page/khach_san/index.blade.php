                            ...
                            <tr v-for="(value, key) in list_khachsan">
                                <th class="text-center align-middle">@{{ key + 1 }}</th>
                                    ...
                                    <td class="text-center text-nowrap">
                                        <button v-on:click="doiTrangThai(value)" v-if="value.trang_thai == 1" class="btn btn-success">Còn Phòng</button>
                                        <button v-on:click="doiTrangThai(value)" v-else class="btn btn-warning">Hết Phòng</button>
                                    </td>
                                    <td class="text-center text-nowrap">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Thông Tin</label>
                                            <textarea v-model="edit.thong_tin" class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Hình Ảnh</label>
                                            <div class="input-group">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <button type="button" v-on:click="capNhatKhachSan()" class="btn btn-primary" data-dismiss="modal">Cập Nhật</button>
                                </div>
                              </div>
                            </div>
                        </div>
                        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                  <button type="button" v-on:click="xoaKhachSan()" class="btn btn-danger" data-dismiss="modal">Xóa</button>
                                </div>
                              </div>
                            </div>
                        </div>
        ...
        new Vue({
            ...
            methods :   {
                ...
                capNhatKhachSan(){
                    ...
                    axios
                        .post('/admin/khach-san/update', this.edit)
                        .then((res) => {
                            if(res.data.status == true) {
